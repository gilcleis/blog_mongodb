...
import com.gilclei.course.api_blog_mongo.resources.util.URL;
...
public class PostResouce {
	...
	private ResponseEntity<List<Post>> searchTitle(@RequestParam(value = "text", defaultValue = "") String text){
		text = URL.decodeParam(text);
